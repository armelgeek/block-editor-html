...
export class StateEvent extends Event {
  ...
  playStudioPlayListChanged(studioPlayList: PlayerState['studioPlayList']) {
    this.emit('playStudioPlayListChanged', studioPlayList)
  }
  /**
   * 我的列表更新
   */
  ...
  playStateModeCreatorChanged(mode: PlayerState['modeCreator']) {
    this.emit('playStateModeCreatorChanged', mode)
  }
}
