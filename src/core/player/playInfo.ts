...
const setPlayerMusicInfo = (musicInfo: LX.Music.MusicInfo | LX.Download.ListItem | null) => {
  if (musicInfo) {
    setMusicInfo('progress' in musicInfo ? {
      id: musicInfo.id,
      bdid: musicInfo.metadata.musicInfo.meta.bdid,
      ...
      rawlrc: null,
      isStudio: false,
      popularite: musicInfo.metadata.musicInfo.popularite,
      createdat: musicInfo.metadata.musicInfo.createdat,
      username: musicInfo.metadata.musicInfo.username

    } : {
      id: musicInfo.id,
      bdid: musicInfo.meta.bdid,
      ...
      rawlrc: null,
      isStudio: false,
      popularite: musicInfo.popularite,
      createdat: musicInfo.createdat,
      username: musicInfo.username
    })
 ...
 */
export const setPlayMusicInfo = (listId: string | null, musicInfo: LX.Download.ListItem | LX.Music.MusicInfo | null, isTempPlay: boolean = false, isStudioPlay: boolean = false) => {
  playerActions.setPlayMusicInfo(listId, musicInfo, isTempPlay,isStudioPlay)
