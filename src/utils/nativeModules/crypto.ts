...
export const rsaEncrypt = async(text: string, key: string, padding: RSA_PADDING) => {
  // console.log(sourceFilePath, targetFilePath)
...
export const rsaDecrypt = async(text: string, key: string, padding: RSA_PADDING) => {
  // console.log(sourceFilePath, targetFilePath)
...
export const rsaEncryptSync = (text: string, key: string, padding: RSA_PADDING) => {
  // console.log(sourceFilePath, targetFilePath)
...
export const rsaDecryptSync = (text: string, key: string, padding: RSA_PADDING) => {
  // console.log(sourceFilePath, targetFilePath)
...
export const aesEncrypt = async(text: string, key: string, vi: string, mode: AES_MODE) => {
  // console.log(sourceFilePath, targetFilePath)
  //return CryptoModule.aesEncrypt(text, key, vi, mode)
}

export const aesDecrypt = async(text: string, key: string, vi: string, mode: AES_MODE) => {
  // console.log(sourceFilePath, targetFilePath)
 // return CryptoModule.aesDecrypt(text, key, vi, mode)
}

export const aesEncryptSync = (text: string, key: string, vi: string, mode: AES_MODE) => {
  // console.log(sourceFilePath, targetFilePath)
  //return CryptoModule.aesEncryptSync(text, key, vi, mode)
}

export const aesDecryptSync = (text: string, key: string, vi: string, mode: AES_MODE) => {
  // console.log(sourceFilePath, targetFilePath)
