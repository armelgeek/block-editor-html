...
//ルビ付き（かもしれない）文字
import {KaraokeUnit, TimeTagElement} from "./lyrics";

export class RubyUnit
{
...
export class RubyLyricsContainer
{
...
export class RubyKaraokeContainer
{
