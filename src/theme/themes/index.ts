...
export const BG_IMAGES = {
  'china_ink.jpg': require('./images/china_ink.jpg') as any,
  'jqbg.jpg': require('./images/jqbg.jpg') as any,
  'landingMoon.png': require('./images/landingMoon2.png') as any,
  'myzcbg.jpg': require('./images/myzcbg.jpg') as any,
  'xnkl.png': require('./images/xnkl.png') as any,
} as const
...
type ColorsKey = keyof any['config']['themeColors']
type ExtInfoKey = keyof any['config']['extInfo']
const varColorRxp = /^var\((.+)\)$/
export const buildActiveThemeColors = (theme: any): any => {
  let bgImg: any | undefined
  if (theme.isCustom) {
  ...
  for (const [k, v] of Object.entries(theme.config.extInfo) as Array<[ExtInfoKey, any['config']['extInfo'][ExtInfoKey]]>) {
