import { Action, ActionType, IState } from "../pages/songs/SongForm";
import { State as PrefState } from "../hooks/usePref";
import { convertTimeToTag, formatText, ILyric } from "@lrc-maker/lrc-parser";
import { audioRef, currentTimePubSub } from "../utils/audiomodule";
...
export const Synchronizer: React.FC<ISynchronizerProps> = ({ state, dispatch }) => {
    ...
    useEffect(() => {
        dispatch({
            ...
            payload: {
                name: "tool",
                value: `${'Tiakalo'} https://tiakalo.mg`,
            },
        });
    }, [dispatch]);
