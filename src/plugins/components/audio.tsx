...
import { AudioActionType, audioRef, AudioState, audioStatePubSub, currentTimePubSub } from "../utils/audiomodule";
import { loadAudioDialogRef } from "./loadaudio";
import { Forward5sSVG, LoadAudioSVG, PauseSVG, PlaySVG, Replay5sSVG } from "./svg";
...
const RateSlider: React.FC<any> = () => {
    ...
    return (
        <>
            <button className="ripple glow" title={'reset rate'} onClick={onPlaybackRateReset}>
                {"X "}
...
export const LrcAudio: React.FC<any> = () => {
    ...
    return (
        <section className={"lrc-audio" + (paused ? "" : " playing")}>
            ...
            <button className="ripple glow" title={'replay5s'} onClick={onReplay5s} disabled={!duration}>
                <Replay5sSVG />
            </button>
            <button
            ...
            <button className="ripple glow" title={'forward5s'} onClick={onForward5s} disabled={!duration}>
                <Forward5sSVG />
            </button>
